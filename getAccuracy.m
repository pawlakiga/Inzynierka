function [accuracy] = getAccuracy(modelFile,testFile,modelRepsNo,testRepsNo,degree,cropParam,ax)

allModelValues = readValues(modelFile ) ; 
allTestValues = readValues(testFile) ;
...
[s,e] = countAndCompareCropped(allTestValues, polyModel, 0.5/cropParam*polyModel.sourceLength, 1.5/cropParam*polyModel.sourceLength, 0.9);
